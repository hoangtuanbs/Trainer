...
@class MediaItem, PlayList, ClockItem, AVController, AudioFile;
...
@interface HitMusicAppDelegate : NSObject <UIApplicationDelegate, UITableViewDataSource>{
	...
	NSString					*playListsDate;
	
	// Phone synch with music vars
	NSDate *myDate;
	NSString *year;
	NSString *dayOfTheYear;
	NSString *hourOfDay;
	NSString *hourOfDay2;
...
@property (nonatomic, retain)	MediaItem			*tempMediaItem;
@property (nonatomic, retain)	NSString			*playListsDate;
@property (nonatomic, retain)	NSDate				*myDate;
@property (nonatomic, retain)	NSString			*year;
@property (nonatomic, retain)	NSString			*dayOfTheYear;
@property (nonatomic, retain)	NSString			*hourOfDay;
@property (nonatomic, retain)	NSString			*hourOfDay2;
@property (nonatomic, retain)	NSString			*monthOfYear;
@property (nonatomic, retain)	NSString			*dayOfMonth;
