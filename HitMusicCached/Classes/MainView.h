...
@interface MainView : UIView {
	...
	IBOutlet UIImageView		*imgInTheNews;
	...
	IBOutlet UIBarButtonItem	*hateItButton;
...
@property (nonatomic, retain)	IBOutlet UIImageView		*imgInTheNews;
...
@property (nonatomic, retain)	IBOutlet UIBarButtonItem	*hateItButton;
...
@property (nonatomic, retain)	IBOutlet UIBarButtonItem	*chatButton;
